...
import com.jero.general.utils.DBTypeConstant;
...
//        gc.setXmlName("%sMapper");
        ...
        focList.add(new FileOutConfig(entityTemplatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                String moduleNameFinal = moduleName.replace(".", "/");
                return projectPath + "/src/main/java/com/jero/" + moduleNameFinal + "/entity/" + tableInfo.getEntityName() + "EO" +
                        StringPool.DOT_JAVA;
            }
        });
